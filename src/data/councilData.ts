...
export const mockCouncils: Council[] = [
    ...
    },
    {
        ...
        sessions: [
            { id: 's-06', student_name: 'Đinh Tuấn Anh', mssv: 'SV20201111', thesis_title: 'ERP cho doanh nghiệp vừa và nhỏ', time_start: '13:30', time_end: '14:15', room: 'Phòng 202-B1', status: 'Chờ diễn ra' },
